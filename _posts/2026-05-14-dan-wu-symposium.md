...
categories: lab-life
thumbnail: assets/img/dan_symposium_1.jpg
images:
  slider: true
---
...
<swiper-container keyboard="true" navigation="true" pagination="true" pagination-clickable="true" pagination-dynamic-bullets="true" rewind="true">
  <swiper-slide>{% include figure.liquid loading="eager" path="assets/img/dan_symposium_1.jpg" class="img-fluid rounded z-depth-1" %}</swiper-slide>
  <swiper-slide>{% include figure.liquid loading="eager" path="assets/img/dan_symposium_2.jpg" class="img-fluid rounded z-depth-1" %}</swiper-slide>
  <swiper-slide>{% include figure.liquid loading="eager" path="assets/img/dan_symposium_3.jpg" class="img-fluid rounded z-depth-1" %}</swiper-slide>
</swiper-container>
